...
/** 목록 카드: 조회수 · 추천 · 좋아요 (아이콘+숫자) */
function ListingEngagementCounts({
  viewCount,
  recommendCount,
  likeCount = 0,
}: {
